...
RUN_ID=r3.0-inductor-8to16-port18001-20260709-1024
...
export PYTHONPATH=/public/home/xdzs2026_c166/codex_runs/r3.0-inductor-8to16-port18001-20260709-1024/sitecustomize:/usr/local
export XDB_INDUCTOR_DUMP_CONFIG=1
export XDB_INDUCTOR_CONFIG_JSON=/public/home/xdzs2026_c166/codex_runs/r3.0-inductor-8to16-port18001-20260709-1024/config/config.json
...
if [ -n "$OVERLAY_REV" ] || [ -n "$OVERLAY_SOURCE_DIR" ]; then
  ...
  for file in             vllm/model_executor/models/qwen3_5.py             vllm/model_executor/models/qwen3_next.py             vllm/model_executor/layers/activation.py             vllm/model_executor/layers/fla/ops/chunk.py             vllm/model_executor/layers/fla/ops/chunk_o.py             vllm/v1/attention/backends/triton_attn.py             vllm/v1/attention/ops/triton_unified_attention.py             vllm/version.py
  do
    src=""
