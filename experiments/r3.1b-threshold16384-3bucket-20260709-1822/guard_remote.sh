...
RUN_ID=r3.1b-threshold16384-3bucket-20260709-1822
...
LOCAL_MODEL_DIR=/root/.xdb_guard_no_local_model_r3.1b-threshold16384-3bucket-20260709-1822
COPY_MODEL_LOCAL=0
NUM_PROMPTS=3
REPETITIONS=3
...
OVERLAY_REV=''
OVERLAY_SOURCE_DIR=/public/home/xdzs2026_c166/vllm_cscc_codex_r31b_threshold_20260709_173633
ACCURACY=none
ACCURACY_ROWS=''
...
export VLLM_TRITON_FUSED_PREFILL=1
export VLLM_TRITON_FUSED_PREFILL_MAX_SEQ_LEN=16384
...
if [ -n "$OVERLAY_REV" ] || [ -n "$OVERLAY_SOURCE_DIR" ]; then
  ...
  for file in             vllm/model_executor/models/qwen3_5.py             vllm/model_executor/models/qwen3_next.py             vllm/model_executor/layers/activation.py             vllm/model_executor/layers/fla/ops/chunk.py             vllm/model_executor/layers/fla/ops/chunk_o.py             vllm/v1/attention/backends/triton_attn.py             vllm/v1/attention/ops/triton_flash_prefill.py             vllm/v1/attention/ops/triton_unified_attention.py             vllm/version.py
  do
    src=""
